...
const CompanyDashboard: React.FC = () => {
  ...
  return (
    <section>
      ...
      <div className="flex flex-col my-5 gap-4 md:flex-row">
        <div className="flex flex-col gap-y-4 bg-green-700 rounded-md shadow-lg text-white w-1/5 p-5 cursor-pointer transition-opacity dark:bg-green-950 hover:opacity-80">
